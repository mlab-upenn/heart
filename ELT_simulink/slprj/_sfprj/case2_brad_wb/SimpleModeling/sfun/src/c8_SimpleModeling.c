...
static void finalize_c8_SimpleModeling(SFc8_SimpleModelingInstanceStruct
  *chartInstance);
static void sf_c8_SimpleModeling(SFc8_SimpleModelingInstanceStruct
  *chartInstance);
static void initSimStructsc8_SimpleModeling(SFc8_SimpleModelingInstanceStruct
  *chartInstance);
static void registerMessagesc8_SimpleModeling(SFc8_SimpleModelingInstanceStruct *
  chartInstance);
...
static boolean_T c8_d_emlrt_marshallIn(SFc8_SimpleModelingInstanceStruct
  *chartInstance, const mxArray *c8_PVC, const char_T *c8_identifier);
...
{
  boolean_T *c8_PVC;
  c8_PVC = (boolean_T *)ssGetOutputPortSignal(chartInstance->S, 1);
  ...
  *chartInstance, const mxArray *c8_st)
{
  ...
  *c8_PVC = c8_d_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c8_u,
    0)), "PVC");
  ...
  *chartInstance)
{
  ...
  boolean_T c8_c_out;
  boolean_T *c8_st_en;
  uint16_T *c8_count_def;
  boolean_T *c8_act;
  boolean_T *c8_PVC;
  c8_PVC = (boolean_T *)ssGetOutputPortSignal(chartInstance->S, 1);
  c8_act = (boolean_T *)ssGetInputPortSignal(chartInstance->S, 2);
  c8_count_def = (uint16_T *)ssGetInputPortSignal(chartInstance->S, 1);
  c8_st_en = (boolean_T *)ssGetInputPortSignal(chartInstance->S, 0);
  ...
  _SFD_DATA_RANGE_CHECK((real_T)*c8_st_en, 0U);
  _SFD_DATA_RANGE_CHECK((real_T)*c8_count_def, 1U);
  _SFD_DATA_RANGE_CHECK((real_T)*c8_act, 2U);
  _SFD_DATA_RANGE_CHECK((real_T)*c8_PVC, 3U);
  ...
  switch (chartInstance->c8_is_c8_SimpleModeling) {
   case c8_IN_Count:
    ...
    c8_out = (CV_TRANSITION_EVAL(1U, (int32_T)_SFD_CCP_CALL(1U, 0,
                chartInstance->c8_count == 0 != 0U, chartInstance->c8_sfEvent))
              != 0);
    if (c8_out) {
   ...
   case c8_IN_Wait:
    ...
    c8_b_out = (CV_TRANSITION_EVAL(3U, (int32_T)_SFD_CCP_CALL(3U, 0, (int16_T)
      *c8_st_en == 1 != 0U, chartInstance->c8_sfEvent)) != 0);
    if (c8_b_out) {
   ...
   case c8_IN_start:
    ...
    c8_c_out = (CV_TRANSITION_EVAL(0U, (int32_T)_SFD_CCP_CALL(0U, 0, (int16_T)
      *c8_act == 1 != 0U, chartInstance->c8_sfEvent)) != 0);
    if (c8_c_out) {
      _SFD_CT_CALL(TRANSITION_ACTIVE_TAG, 0U, chartInstance->c8_sfEvent);
      chartInstance->c8_count = *c8_count_def;
      _SFD_DATA_RANGE_CHECK((real_T)chartInstance->c8_count, 4U);
      chartInstance->c8_tp_start = 0U;
      _SFD_CS_CALL(STATE_INACTIVE_TAG, 2U, chartInstance->c8_sfEvent);
  ...
  *chartInstance, const mxArray *c8_PVC, const char_T *c8_identifier)
{
  ...
  c8_thisId.fIdentifier = c8_identifier;
  c8_thisId.fParent = NULL;
  c8_y = c8_e_emlrt_marshallIn(chartInstance, sf_mex_dup(c8_PVC), &c8_thisId);
  sf_mex_destroy(&c8_PVC);
  return c8_y;
}
...
static void c8_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c8_mxArrayInData, const char_T *c8_varName, void *c8_outData)
{
  const mxArray *c8_PVC;
  const char_T *c8_identifier;
  emlrtMsgIdentifier c8_thisId;
  boolean_T c8_y;
  SFc8_SimpleModelingInstanceStruct *chartInstance;
  chartInstance = (SFc8_SimpleModelingInstanceStruct *)chartInstanceVoid;
  c8_PVC = sf_mex_dup(c8_mxArrayInData);
  c8_identifier = c8_varName;
  c8_thisId.fIdentifier = c8_identifier;
  c8_thisId.fParent = NULL;
  c8_y = c8_e_emlrt_marshallIn(chartInstance, sf_mex_dup(c8_PVC), &c8_thisId);
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2675031874U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(402557564U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(3146376205U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3535780846U);
}
...
mxArray *sf_c8_SimpleModeling_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("AeTbHjUUw7ZhnuelxIR5LC");
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc8_SimpleModelingInstanceStruct *chartInstance;
    chartInstance = (SFc8_SimpleModelingInstanceStruct *) ((ChartInfoStruct *)
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
...

        {
          ...
          c8_count_def = (uint16_T *)ssGetInputPortSignal(chartInstance->S, 1);
          c8_st_en = (boolean_T *)ssGetInputPortSignal(chartInstance->S, 0);
          _SFD_SET_DATA_VALUE_PTR(0U, c8_st_en);
          _SFD_SET_DATA_VALUE_PTR(1U, c8_count_def);
          _SFD_SET_DATA_VALUE_PTR(2U, c8_act);
          _SFD_SET_DATA_VALUE_PTR(3U, c8_PVC);
...
{
  sf_c8_SimpleModeling((SFc8_SimpleModelingInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c8_SimpleModeling(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c8_SimpleModeling
    ((SFc8_SimpleModelingInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c8_SimpleModeling();/* state var info */
...
extern void sf_internal_set_sim_state_c8_SimpleModeling(SimStruct* S, const
  mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
...
{
  return sf_internal_get_sim_state_c8_SimpleModeling(S);
}

static void sf_opaque_set_sim_state_c8_SimpleModeling(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c8_SimpleModeling(S, st);
}
...
static void mdlSetWorkWidths_c8_SimpleModeling(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(2026610933U));
  ssSetChecksum1(S,(3009010424U));
  ssSetChecksum2(S,(1702583536U));
  ssSetChecksum3(S,(2630038904U));
