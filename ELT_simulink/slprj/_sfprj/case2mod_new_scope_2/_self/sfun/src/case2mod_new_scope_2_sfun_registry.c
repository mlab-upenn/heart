...
unsigned int sf_process_check_sum_call( int nlhs, mxArray * plhs[], int nrhs,
  const mxArray * prhs[] )
{
  extern unsigned int sf_case2mod_new_scope_2_process_check_sum_call( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  extern unsigned int sf_SimpleModeling_process_check_sum_call( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  if (sf_case2mod_new_scope_2_process_check_sum_call(nlhs,plhs,nrhs,prhs))
    return 1;
...
{
  extern unsigned int sf_case2mod_new_scope_2_autoinheritance_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  ...
  if (strcmp(machineName, "case2mod_new_scope_2") == 0) {
    const mxArray *newRhs[3] = { NULL, NULL, NULL };

    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_case2mod_new_scope_2_autoinheritance_info(nlhs,plhs,3,newRhs);
  }
...
unsigned int sf_process_get_third_party_uses_info_call( int nlhs, mxArray *
  plhs[], int nrhs, const mxArray * prhs[] )
{
  extern unsigned int sf_case2mod_new_scope_2_third_party_uses_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  ...
  if (strcmp(machineName, "case2mod_new_scope_2") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_case2mod_new_scope_2_third_party_uses_info(nlhs,plhs,3,newRhs);
  }
...
unsigned int sf_process_get_eml_resolved_functions_info_call( int nlhs, mxArray *
  plhs[], int nrhs, const mxArray * prhs[] )
{
  extern unsigned int sf_case2mod_new_scope_2_get_eml_resolved_functions_info
  ...
  if (strcmp(machineName, "case2mod_new_scope_2") == 0) {
    ...
    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    return sf_case2mod_new_scope_2_get_eml_resolved_functions_info(nlhs,plhs,2,
      newRhs);
  }
...
extern unsigned int sf_case2mod_new_scope_2_method_dispatcher(SimStruct *S,
...
unsigned int sf_machine_global_method_dispatcher(SimStruct *simstructPtr, const
  ...
  method, void *data)
{
  if (!strcmp(machineName,"case2mod_new_scope_2")) {
    return(sf_case2mod_new_scope_2_method_dispatcher(simstructPtr,
...
extern void case2mod_new_scope_2_terminator(void);
...
void sf_machine_global_terminator(void)
{
  ...
  if (sfGlobalMdlStartCallCounts == 0) {
    case2mod_new_scope_2_terminator();
...
extern void case2mod_new_scope_2_initializer(void);
extern void SimpleModeling_initializer(void);
extern void case2mod_new_scope_2_register_exported_symbols(SimStruct* S);
extern void SimpleModeling_register_exported_symbols(SimStruct* S);
extern void case2mod_new_scope_2_debug_initialize(struct SfDebugInstanceStruct*);
...
{
  case2mod_new_scope_2_register_exported_symbols(S);
...
void sf_machine_global_initializer(SimStruct* S)
{
  ...
  if (sfGlobalMdlStartCallCounts == 1) {
    ...
    if (!simModeIsRTWGen) {
      case2mod_new_scope_2_debug_initialize(sfGlobalDebugInstanceStruct);
    }

    case2mod_new_scope_2_initializer();
    if (!simModeIsRTWGen) {
