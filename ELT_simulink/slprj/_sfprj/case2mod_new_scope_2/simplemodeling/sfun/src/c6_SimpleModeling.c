...
static void finalize_c6_SimpleModeling(SFc6_SimpleModelingInstanceStruct
  *chartInstance);
static void sf_c6_SimpleModeling(SFc6_SimpleModelingInstanceStruct
  *chartInstance);
static void initSimStructsc6_SimpleModeling(SFc6_SimpleModelingInstanceStruct
  *chartInstance);
static void registerMessagesc6_SimpleModeling(SFc6_SimpleModelingInstanceStruct *
  chartInstance);
...
static void c6_PVARP(SFc6_SimpleModelingInstanceStruct *chartInstance);
...
static boolean_T c6_f_emlrt_marshallIn(SFc6_SimpleModelingInstanceStruct
  *chartInstance, const mxArray *c6_LRIout, const char_T *c6_identifier);
...
static real_T c6_j_emlrt_marshallIn(SFc6_SimpleModelingInstanceStruct
  *chartInstance, const mxArray *c6_AR, const char_T *c6_identifier);
  ...
  *chartInstance)
{
  ...
  boolean_T *c6_VRPout;
  real_T *c6_AR;
  c6_AR = (real_T *)ssGetOutputPortSignal(chartInstance->S, 5);
  c6_VRPout = (boolean_T *)ssGetOutputPortSignal(chartInstance->S, 4);
  c6_ARPout = (boolean_T *)ssGetOutputPortSignal(chartInstance->S, 3);
  c6_AVIout = (boolean_T *)ssGetOutputPortSignal(chartInstance->S, 2);
  c6_LRIout = (boolean_T *)ssGetOutputPortSignal(chartInstance->S, 1);
  ...
  *chartInstance, const mxArray *c6_st)
{
  ...
  *c6_AR = c6_j_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c6_u,
    0)), "AR");
  *c6_ARPout = c6_f_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
    (c6_u, 1)), "ARPout");
  *c6_AVIout = c6_f_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
    (c6_u, 2)), "AVIout");
  *c6_LRIout = c6_f_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
    (c6_u, 3)), "LRIout");
  *c6_VRPout = c6_f_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
    (c6_u, 4)), "VRPout");
  ...
  *chartInstance)
{
  ...
  real_T *c6_AR;
  c6_AR = (real_T *)ssGetOutputPortSignal(chartInstance->S, 5);
  c6_VRPdef = (uint16_T *)ssGetInputPortSignal(chartInstance->S, 6);
  c6_URIdef = (uint16_T *)ssGetInputPortSignal(chartInstance->S, 5);
  c6_AVIdef = (uint16_T *)ssGetInputPortSignal(chartInstance->S, 4);
  c6_ARPdef = (uint16_T *)ssGetInputPortSignal(chartInstance->S, 3);
  c6_LRIdef = (uint16_T *)ssGetInputPortSignal(chartInstance->S, 2);
  c6_Vin = (boolean_T *)ssGetInputPortSignal(chartInstance->S, 1);
  c6_VRPout = (boolean_T *)ssGetOutputPortSignal(chartInstance->S, 4);
  c6_ARPout = (boolean_T *)ssGetOutputPortSignal(chartInstance->S, 3);
  c6_AVIout = (boolean_T *)ssGetOutputPortSignal(chartInstance->S, 2);
  c6_Ain = (boolean_T *)ssGetInputPortSignal(chartInstance->S, 0);
  c6_LRIout = (boolean_T *)ssGetOutputPortSignal(chartInstance->S, 1);
  ...
  _SFD_DATA_RANGE_CHECK((real_T)*c6_LRIout, 1U);
  _SFD_DATA_RANGE_CHECK((real_T)*c6_Ain, 2U);
  _SFD_DATA_RANGE_CHECK((real_T)*c6_AVIout, 3U);
  _SFD_DATA_RANGE_CHECK((real_T)*c6_ARPout, 4U);
  _SFD_DATA_RANGE_CHECK((real_T)*c6_VRPout, 5U);
  _SFD_DATA_RANGE_CHECK((real_T)*c6_Vin, 6U);
  ...
  _SFD_DATA_RANGE_CHECK((real_T)*c6_LRIdef, 11U);
  _SFD_DATA_RANGE_CHECK((real_T)*c6_ARPdef, 12U);
  _SFD_DATA_RANGE_CHECK((real_T)*c6_AVIdef, 13U);
  _SFD_DATA_RANGE_CHECK((real_T)*c6_URIdef, 14U);
  _SFD_DATA_RANGE_CHECK((real_T)chartInstance->c6_AVIst, 15U);
  _SFD_DATA_RANGE_CHECK((real_T)chartInstance->c6_URIst, 16U);
  _SFD_DATA_RANGE_CHECK((real_T)*c6_VRPdef, 17U);
  _SFD_DATA_RANGE_CHECK(*c6_AR, 18U);
  chartInstance->c6_sfEvent = CALL_EVENT;
  ...
  if (chartInstance->c6_is_active_c6_SimpleModeling == 0U) {
    ...
    chartInstance->c6_LRIcur = *c6_LRIdef;
    _SFD_DATA_RANGE_CHECK((real_T)chartInstance->c6_LRIcur, 0U);
    *c6_LRIout = FALSE;
    _SFD_DATA_RANGE_CHECK((real_T)*c6_LRIout, 1U);
    ...
    *c6_AVIout = FALSE;
    ...
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 2U, chartInstance->c6_sfEvent);
    chartInstance->c6_tp_st1 = 1U;
    chartInstance->c6_AVIcur = c6__s16_u16_(chartInstance, *c6_AVIdef);
    _SFD_DATA_RANGE_CHECK((real_T)chartInstance->c6_AVIcur, 7U);
    ...
    *c6_ARPout = FALSE;
    _SFD_DATA_RANGE_CHECK((real_T)*c6_ARPout, 4U);
    chartInstance->c6_ARPcur = *c6_ARPdef;
    _SFD_DATA_RANGE_CHECK((real_T)chartInstance->c6_ARPcur, 8U);
    ...
    *c6_VRPout = FALSE;
    ...
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 13U, chartInstance->c6_sfEvent);
    chartInstance->c6_tp_VRPst1 = 1U;
    chartInstance->c6_VRPcur = *c6_VRPdef;
    _SFD_DATA_RANGE_CHECK((real_T)chartInstance->c6_VRPcur, 9U);
    ...
    _SFD_DATA_RANGE_CHECK((real_T)chartInstance->c6_URIst, 16U);
    chartInstance->c6_URIcur = *c6_URIdef;
    _SFD_DATA_RANGE_CHECK((real_T)chartInstance->c6_URIcur, 10U);
  } else {
...
static void c6_pacemakerDDD(SFc6_SimpleModelingInstanceStruct *chartInstance)
{
  ...
  switch (chartInstance->c6_is_AVI) {
   case c6_IN_st1:
    ...
    c6_temp = (_SFD_CCP_CALL(3U, 0, *c6_LRIout != 0U, chartInstance->c6_sfEvent)
               != 0);
    if (!c6_temp) {
      c6_temp = (_SFD_CCP_CALL(3U, 1, *c6_ARPout != 0U,
   ...
   case c6_IN_st2:
    ...
    c6_b_out = (CV_TRANSITION_EVAL(4U, (int32_T)_SFD_CCP_CALL(4U, 0, *c6_VRPout
    ...
    if (c6_b_out) {
      if (_SFD_TRANSITION_CONFLICT_CHECK_ENABLED()) {
        ...
        c6_c_out = ((chartInstance->c6_AVIcur <= 0) && ((int16_T)
          chartInstance->c6_URIst == 1));
        if (c6_c_out) {
      ...
      *c6_AVIout = FALSE;
      ...
      _SFD_CT_CALL(TRANSITION_BEFORE_PROCESSING_TAG, 5U,
                   chartInstance->c6_sfEvent);
      c6_b_temp = (_SFD_CCP_CALL(5U, 0, chartInstance->c6_AVIcur <= 0 != 0U,
        chartInstance->c6_sfEvent) != 0);
      if (c6_b_temp) {
        c6_b_temp = (_SFD_CCP_CALL(5U, 1, (int16_T)chartInstance->c6_URIst == 1
          != 0U, chartInstance->c6_sfEvent) != 0);
      }

      c6_d_out = (CV_TRANSITION_EVAL(5U, (int32_T)c6_b_temp) != 0);
      if (c6_d_out) {
  ...
  switch (chartInstance->c6_is_VRP) {
   case c6_IN_VRPst1:
    ...
    _SFD_CT_CALL(TRANSITION_BEFORE_PROCESSING_TAG, 11U,
                 chartInstance->c6_sfEvent);
    c6_e_out = (CV_TRANSITION_EVAL(11U, (int32_T)_SFD_CCP_CALL(11U, 0, *c6_Vin
      != 0U, chartInstance->c6_sfEvent)) != 0);
    if (c6_e_out) {
      if (_SFD_TRANSITION_CONFLICT_CHECK_ENABLED()) {
        unsigned int transitionList[2];
      ...
      *c6_VRPout = *c6_Vin;
      ...
      _SFD_CT_CALL(TRANSITION_BEFORE_PROCESSING_TAG, 19U,
                   chartInstance->c6_sfEvent);
      c6_g_out = (CV_TRANSITION_EVAL(19U, (int32_T)_SFD_CCP_CALL(19U, 0,
        *c6_AVIout != 0U, chartInstance->c6_sfEvent)) != 0);
      if (c6_g_out) {
   ...
   case c6_IN_VRPst2:
    ...
    _SFD_CT_CALL(TRANSITION_BEFORE_PROCESSING_TAG, 12U,
                 chartInstance->c6_sfEvent);
    c6_h_out = (CV_TRANSITION_EVAL(12U, (int32_T)_SFD_CCP_CALL(12U, 0,
      chartInstance->c6_VRPcur == 0 != 0U, chartInstance->c6_sfEvent)) != 0);
    if (c6_h_out) {
  ...
  switch (chartInstance->c6_is_URI) {
   case c6_IN_URIst1:
    ...
    _SFD_CT_CALL(TRANSITION_BEFORE_PROCESSING_TAG, 14U,
                 chartInstance->c6_sfEvent);
    c6_c_temp = (_SFD_CCP_CALL(14U, 0, *c6_AVIout != 0U,
      chartInstance->c6_sfEvent) != 0);
    if (!c6_c_temp) {
      c6_c_temp = (_SFD_CCP_CALL(14U, 1, *c6_VRPout != 0U,
        chartInstance->c6_sfEvent) != 0);
    }

    c6_i_out = (CV_TRANSITION_EVAL(14U, (int32_T)c6_c_temp) != 0);
    if (c6_i_out) {
   ...
   case c6_IN_URIst2:
    ...
    _SFD_CT_CALL(TRANSITION_BEFORE_PROCESSING_TAG, 15U,
                 chartInstance->c6_sfEvent);
    c6_d_temp = (_SFD_CCP_CALL(15U, 0, chartInstance->c6_URIcur == 0 != 0U,
      chartInstance->c6_sfEvent) != 0);
    if (c6_d_temp) {
      c6_d_temp = (_SFD_CCP_CALL(15U, 1, chartInstance->c6_AVIcur < 0 != 0U,
        chartInstance->c6_sfEvent) != 0);
    }

    c6_j_out = (CV_TRANSITION_EVAL(15U, (int32_T)c6_d_temp) != 0);
    if (c6_j_out) {
      if (_SFD_TRANSITION_CONFLICT_CHECK_ENABLED()) {
        unsigned int transitionList[2];
        unsigned int numTransitions = 1;
        transitionList[0] = 15;
        _SFD_TRANSITION_CONFLICT_CHECK_BEGIN();
        c6_k_out = (chartInstance->c6_URIcur == 0);
        if (c6_k_out) {
      ...
      *c6_AVIout = TRUE;
      ...
      _SFD_CT_CALL(TRANSITION_BEFORE_PROCESSING_TAG, 16U,
                   chartInstance->c6_sfEvent);
      c6_l_out = (CV_TRANSITION_EVAL(16U, (int32_T)_SFD_CCP_CALL(16U, 0,
        chartInstance->c6_URIcur == 0 != 0U, chartInstance->c6_sfEvent)) != 0);
      if (c6_l_out) {
...
static void c6_LRI(SFc6_SimpleModelingInstanceStruct *chartInstance)
{
  ...
  c6_temp = (_SFD_CCP_CALL(1U, 0, chartInstance->c6_LRIcur == 0 != 0U,
              chartInstance->c6_sfEvent) != 0);
  if (!c6_temp) {
    c6_temp = (_SFD_CCP_CALL(1U, 1, *c6_AVIout != 0U, chartInstance->c6_sfEvent)
               != 0);
  }

  c6_b_temp = c6_temp;
  if (!c6_b_temp) {
    c6_b_temp = (_SFD_CCP_CALL(1U, 2, *c6_VRPout != 0U,
      chartInstance->c6_sfEvent) != 0);
  }
  ...
  if (c6_out) {
    if (_SFD_TRANSITION_CONFLICT_CHECK_ENABLED()) {
      ...
      transitionList[0] = 1;
      _SFD_TRANSITION_CONFLICT_CHECK_BEGIN();
      c6_b_out = ((chartInstance->c6_LRIcur == *c6_AVIdef) && ((int16_T)
        chartInstance->c6_AVIst == 1));
      if (c6_b_out) {
    ...
    *c6_LRIout = FALSE;
    ...
    c6_c_temp = (_SFD_CCP_CALL(0U, 0, chartInstance->c6_LRIcur == *c6_AVIdef !=
      0U, chartInstance->c6_sfEvent) != 0);
    if (c6_c_temp) {
      c6_c_temp = (_SFD_CCP_CALL(0U, 1, (int16_T)chartInstance->c6_AVIst == 1 !=
        0U, chartInstance->c6_sfEvent) != 0);
    }

    c6_c_out = (CV_TRANSITION_EVAL(0U, (int32_T)c6_c_temp) != 0);
    if (c6_c_out) {
...
static void c6_PVARP(SFc6_SimpleModelingInstanceStruct *chartInstance)
{
  ...
  switch (chartInstance->c6_is_PVARP) {
   case c6_IN_ARPs1:
    ...
    c6_temp = (_SFD_CCP_CALL(7U, 0, *c6_Ain != 0U, chartInstance->c6_sfEvent) !=
               0);
    if (c6_temp) {
      c6_temp = (_SFD_CCP_CALL(7U, 1, (int16_T)chartInstance->c6_AVIst == 1 !=
                  0U, chartInstance->c6_sfEvent) != 0);
    }

    c6_b_temp = c6_temp;
    if (c6_b_temp) {
      c6_b_temp = !(_SFD_CCP_CALL(7U, 2, *c6_AVIout != 0U,
        chartInstance->c6_sfEvent) != 0);
    }

    c6_c_temp = c6_b_temp;
    if (c6_c_temp) {
      c6_c_temp = !(_SFD_CCP_CALL(7U, 3, *c6_VRPout != 0U,
        chartInstance->c6_sfEvent) != 0);
    }
    ...
    if (c6_out) {
      ...
      *c6_ARPout = TRUE;
      ...
      _SFD_CT_CALL(TRANSITION_BEFORE_PROCESSING_TAG, 8U,
                   chartInstance->c6_sfEvent);
      c6_d_temp = (_SFD_CCP_CALL(8U, 0, *c6_AVIout != 0U,
        chartInstance->c6_sfEvent) != 0);
      if (!c6_d_temp) {
        c6_d_temp = (_SFD_CCP_CALL(8U, 1, *c6_VRPout != 0U,
          chartInstance->c6_sfEvent) != 0);
      }

      c6_c_out = (CV_TRANSITION_EVAL(8U, (int32_T)c6_d_temp) != 0);
      if (c6_c_out) {
   ...
   case c6_IN_ARPs2:
    ...
    c6_d_out = (CV_TRANSITION_EVAL(9U, (int32_T)_SFD_CCP_CALL(9U, 0,
      chartInstance->c6_ARPcur == 0 != 0U, chartInstance->c6_sfEvent)) != 0);
    if (c6_d_out) {
      if (_SFD_TRANSITION_CONFLICT_CHECK_ENABLED()) {
        unsigned int transitionList[2];
        unsigned int numTransitions = 1;
      ...
      _SFD_CT_CALL(TRANSITION_BEFORE_PROCESSING_TAG, 18U,
                   chartInstance->c6_sfEvent);
      c6_f_out = (CV_TRANSITION_EVAL(18U, (int32_T)_SFD_CCP_CALL(18U, 0, *c6_Ain
        != 0U, chartInstance->c6_sfEvent)) != 0);
      if (c6_f_out) {
  ...
  *chartInstance, const mxArray *c6_LRIout, const char_T *c6_identifier)
{
  ...
  c6_thisId.fIdentifier = c6_identifier;
  c6_thisId.fParent = NULL;
  c6_y = c6_g_emlrt_marshallIn(chartInstance, sf_mex_dup(c6_LRIout), &c6_thisId);
  sf_mex_destroy(&c6_LRIout);
  return c6_y;
}
...
static void c6_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c6_mxArrayInData, const char_T *c6_varName, void *c6_outData)
{
  const mxArray *c6_LRIout;
  const char_T *c6_identifier;
  emlrtMsgIdentifier c6_thisId;
  boolean_T c6_y;
  SFc6_SimpleModelingInstanceStruct *chartInstance;
  chartInstance = (SFc6_SimpleModelingInstanceStruct *)chartInstanceVoid;
  c6_LRIout = sf_mex_dup(c6_mxArrayInData);
  c6_identifier = c6_varName;
  c6_thisId.fIdentifier = c6_identifier;
  c6_thisId.fParent = NULL;
  c6_y = c6_g_emlrt_marshallIn(chartInstance, sf_mex_dup(c6_LRIout), &c6_thisId);
  ...
  *chartInstance, const mxArray *c6_AR, const char_T *c6_identifier)
{
  ...
  c6_thisId.fIdentifier = c6_identifier;
  c6_thisId.fParent = NULL;
  c6_y = c6_k_emlrt_marshallIn(chartInstance, sf_mex_dup(c6_AR), &c6_thisId);
  sf_mex_destroy(&c6_AR);
  return c6_y;
}
  ...
  *c6_mxArrayInData, const char_T *c6_varName, void *c6_outData)
{
  ...
  SFc6_SimpleModelingInstanceStruct *chartInstance;
  chartInstance = (SFc6_SimpleModelingInstanceStruct *)chartInstanceVoid;
  c6_AR = sf_mex_dup(c6_mxArrayInData);
  c6_identifier = c6_varName;
  c6_thisId.fIdentifier = c6_identifier;
  c6_thisId.fParent = NULL;
  c6_y = c6_k_emlrt_marshallIn(chartInstance, sf_mex_dup(c6_AR), &c6_thisId);
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2468965376U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2912015304U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1125440155U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(1266679630U);
}
...
mxArray *sf_c6_SimpleModeling_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("rm9PeNlluQy0InkvmN8En");
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc6_SimpleModelingInstanceStruct *chartInstance;
    chartInstance = (SFc6_SimpleModelingInstanceStruct *) ((ChartInfoStruct *)
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
...

        {
          ...
          _SFD_SET_DATA_VALUE_PTR(1U, c6_LRIout);
          _SFD_SET_DATA_VALUE_PTR(2U, c6_Ain);
          _SFD_SET_DATA_VALUE_PTR(3U, c6_AVIout);
          _SFD_SET_DATA_VALUE_PTR(4U, c6_ARPout);
          _SFD_SET_DATA_VALUE_PTR(5U, c6_VRPout);
          _SFD_SET_DATA_VALUE_PTR(6U, c6_Vin);
          ...
          _SFD_SET_DATA_VALUE_PTR(11U, c6_LRIdef);
          _SFD_SET_DATA_VALUE_PTR(12U, c6_ARPdef);
          _SFD_SET_DATA_VALUE_PTR(13U, c6_AVIdef);
          _SFD_SET_DATA_VALUE_PTR(14U, c6_URIdef);
          _SFD_SET_DATA_VALUE_PTR(15U, &chartInstance->c6_AVIst);
          _SFD_SET_DATA_VALUE_PTR(16U, &chartInstance->c6_URIst);
          _SFD_SET_DATA_VALUE_PTR(17U, c6_VRPdef);
          _SFD_SET_DATA_VALUE_PTR(18U, c6_AR);
        }
      }
    } else {
...
{
  sf_c6_SimpleModeling((SFc6_SimpleModelingInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c6_SimpleModeling(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c6_SimpleModeling
    ((SFc6_SimpleModelingInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c6_SimpleModeling();/* state var info */
...
extern void sf_internal_set_sim_state_c6_SimpleModeling(SimStruct* S, const
  mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
...
{
  return sf_internal_get_sim_state_c6_SimpleModeling(S);
}

static void sf_opaque_set_sim_state_c6_SimpleModeling(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c6_SimpleModeling(S, st);
}
...
static void mdlSetWorkWidths_c6_SimpleModeling(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(1034065720U));
  ssSetChecksum1(S,(4091801431U));
  ssSetChecksum2(S,(3363891453U));
  ssSetChecksum3(S,(404930609U));
